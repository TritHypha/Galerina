// =============================================================================
// Galerina Runtime — Capability Host (Phase 11C / R4)
//
...
export interface CapabilityCall {
  ...
  readonly args: readonly GalerinaValue[];
...
export interface CapabilityHost {
  ...
  execute(
    call: CapabilityCall,
    impl: (args: readonly GalerinaValue[]) => Promise<GalerinaValue>,
