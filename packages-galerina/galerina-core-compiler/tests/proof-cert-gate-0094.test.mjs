...
// unverified proof (zkRejected, SPORE-PROOF-CERT-001/002; zkProof absent). Dev / pre-ceremony
...
test("#0094 certified: placeholder/forged proof is REFUSED (SPORE-PROOF-CERT-001), not stored", async () => {
  ...
  assert.match(r.zkRejected ?? "", /SPORE-PROOF-CERT-001/);
});
...
test("#0094 certified: a proof that does NOT verify is REJECTED (SPORE-PROOF-CERT-002)", async () => {
  ...
  assert.match(r.zkRejected ?? "", /SPORE-PROOF-CERT-002/);
});
