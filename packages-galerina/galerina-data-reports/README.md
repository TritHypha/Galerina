...
`galerina-data-reports` defines shared data-processing report contracts.
...
Owning data packages produce the facts. This package defines shared report
shape and status vocabulary.
