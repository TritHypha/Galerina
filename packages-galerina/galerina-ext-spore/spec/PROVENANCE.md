...
| | |
|---|---|
| **Upstream (authoring repo)** | `<GitHub>\Galerina-R-AND-D\spore\spec\` |
...
| `spore-container-v0.md` | Slice 2 — container reader/writer ✅ |
| `spore-modalities-v0.md` | Slice 2 — the leaf `modality` registry the container references |
| `spore-encryption-v0.md` | Slice 3 — KEM-DEM confidentiality ✅ (`src/kemdem.ts`) |
...
| `spore-history-chain-v0.md` | Slice 5 — append-only history chain ⬜ |
| `governed-trust-capsule-v0.md` | Slice 5 — Governed Trust Capsule (CWT/COSE) ⬜ |
| `nvfp4-codec-v0.md` | `Vector`-modality NVFP4 codec (used by `spore-modalities`; opaque to TMX, not a crypto slice) |
