 ...
 * (<GitHub>\BitNet\src\ggml-bitnet-mad.cpp, MIT). It reproduces BitNet's
 ...
 *                             parity is claimed — see galerina-tpl-bitnet-fidelity-audit.md.)
 *   scale                 →  i2_scale = max(|weights|), applied after accumulation
 *
 * Galerina additions (the Hardened Border):
