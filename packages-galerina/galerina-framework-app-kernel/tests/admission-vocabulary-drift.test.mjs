...
// allow-list `galerina border-check` validates against — so the two admission gates
...
import { isAdmissibleCapability } from "../../galerina-core-compiler/dist/capability-types.js";
