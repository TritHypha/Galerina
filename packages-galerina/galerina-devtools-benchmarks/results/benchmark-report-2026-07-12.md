# Benchmark report — 2026-07-12 (post-hardening, main f7ff18df/9314189e)

Truth-audit PASSED. Diff vs the pre-hardening baseline (2026-07-12_endphase): perf-neutral (movers are run-to-run noise).

## Cross-language throughput (post-hardening run)
...
## Biggest movers vs pre-hardening baseline

| Benchmark | Runtime | pre | post | Δ% |
|---|---|--:|--:|--:|
