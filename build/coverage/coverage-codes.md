...
Index: code-index.json (664 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (59 FUNGI codes).

## Universal coverage (anchor std #1)
- 664/664 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- INLINE / no exported constant (R4): 146 (std #5 → taxonomy Stage F).
...
## Coverage holes: 0 · curation backlog: 406 · drift: 110 · R4-inline: 146 · RESERVED: 8
