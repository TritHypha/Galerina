...
Index: code-index.json (636 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (59 FUNGI codes).
...
- governance-rules.md CURATION gap: 378 src-real FUNGI-* lack a semantic entry in the curated registry (they ARE in the derived registry). Generate/curate per std #10.
...
## Coverage holes: 0 · curation backlog: 378 · drift: 110 · R4-inline: 145 · RESERVED: 8
