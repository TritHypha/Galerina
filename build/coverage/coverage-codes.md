...
Index: code-index.json (628 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (84 FUNGI codes).

## Universal coverage (anchor std #1)
- 628/628 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- governance-rules.md CURATION gap: 350 src-real FUNGI-* lack a semantic entry in the curated registry (they ARE in the derived registry). Generate/curate per std #10.
- PHANTOM doc-only drift: 103 (std #9/#10 → DOC-004).
- INLINE / no exported constant (R4): 147 (std #5 → taxonomy Stage F).
...
## Coverage holes: 8 · curation backlog: 350 · drift: 103 · R4-inline: 147 · RESERVED: 8
