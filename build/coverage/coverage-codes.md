...
Index: code-index.json (622 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (84 FUNGI codes).

## Universal coverage (anchor std #1)
- 622/622 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- INLINE / no exported constant (R4): 137 (std #5 → taxonomy Stage F).
...
## Coverage holes: 8 · curation backlog: 350 · drift: 109 · R4-inline: 137 · RESERVED: 8
