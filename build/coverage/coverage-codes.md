...
Index: code-index.json (686 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (75 FUNGI codes).

## Universal coverage (anchor std #1)
- 686/686 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- governance-rules.md CURATION gap: 411 src-real FUNGI-* lack a semantic entry in the curated registry (they ARE in the derived registry). Generate/curate per std #10.
...
## Coverage holes: 0 · curation backlog: 411 · drift: 111 · R4-inline: 163 · RESERVED: 8
