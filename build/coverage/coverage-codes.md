...
Index: code-index.json (634 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (84 FUNGI codes).

## Universal coverage (anchor std #1)
- 634/634 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- PHANTOM doc-only drift: 109 (std #9/#10 → DOC-004).
...
## Coverage holes: 8 · curation backlog: 350 · drift: 109 · R4-inline: 147 · RESERVED: 8
