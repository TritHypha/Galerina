...
`docs/Knowledge-Bases/design-patterns-for-galerina.md`
...
`docs/Knowledge-Bases/galerina-200-closeout-2026-06-15.md`
...
`docs/Knowledge-Bases/galerina-34-offline-key-ceremony-runbook.md`
...
`docs/Knowledge-Bases/galerina-agile-governance-pattern.md`
...
`docs/Knowledge-Bases/galerina-ai-memory-efficiency.md`
...
`docs/Knowledge-Bases/galerina-ai-semantic-graph-output.md`
...
`docs/Knowledge-Bases/galerina-aot-tricks-rd.md`
...
`docs/Knowledge-Bases/galerina-api-boundary-architecture.md`
...
`docs/Knowledge-Bases/galerina-asic-cyber-physical.md`
...
`docs/Knowledge-Bases/galerina-benchmark-enforcement-cost-spec.md`
- tasks: #147
...
`docs/Knowledge-Bases/galerina-benchmark-scoreboard-standard.md`
...
`docs/Knowledge-Bases/galerina-benchmark-situation-prompt.md`
...
`docs/Knowledge-Bases/galerina-benchmark-snapshot-2026-06-22.md`
...
`docs/Knowledge-Bases/galerina-benchmark-snapshot-2026-06-24.md`
...
`docs/Knowledge-Bases/galerina-cache-aware-execution.md`
...
`docs/Knowledge-Bases/galerina-calibration-data.md`
...
`docs/Knowledge-Bases/galerina-checkpoint-2026-06-06.md`
...
`docs/Knowledge-Bases/galerina-compliance-packages.md`
...
`docs/Knowledge-Bases/galerina-compliance.md`
...
`docs/Knowledge-Bases/galerina-concept-map.md`
...
`docs/Knowledge-Bases/galerina-contract-economics.md`
...
`docs/Knowledge-Bases/galerina-contracts-as-meaning-layer.md`
...
`docs/Knowledge-Bases/galerina-core-cli-v02.md`
...
`docs/Knowledge-Bases/galerina-core-economics-package.md`
...
`docs/Knowledge-Bases/galerina-core-network-webhook.md`
...
`docs/Knowledge-Bases/galerina-coverage-crosscheck-methodology.md`
- codes: ERR_REGISTRY
...
`docs/Knowledge-Bases/galerina-cpp-bridge.md`
...
`docs/Knowledge-Bases/galerina-data-layout-memory-hints.md`
...
`docs/Knowledge-Bases/galerina-design-primitive-obsession.md`
...
`docs/Knowledge-Bases/galerina-developer-ux-phase-8.md`
...
`docs/Knowledge-Bases/galerina-doc-comment-standard.md`
...
`docs/Knowledge-Bases/galerina-docker-container-profile.md`
...
`docs/Knowledge-Bases/galerina-flow-contracts.md`
...
`docs/Knowledge-Bases/galerina-for-where-tensor-mask-rd.md`
...
`docs/Knowledge-Bases/galerina-framework-api-server-implementation.md`
...
`docs/Knowledge-Bases/galerina-governance-cicd-pipeline.md`
...
`docs/Knowledge-Bases/galerina-governed-apu-memory.md`
...
`docs/Knowledge-Bases/galerina-governed-design-synthesis.md`
- tasks: #58, #36, #59, #37
...
`docs/Knowledge-Bases/galerina-governed-identity.md`
...
`docs/Knowledge-Bases/galerina-gradual-capability-inference.md`
...
`docs/Knowledge-Bases/galerina-hardware-amd.md`
...
`docs/Knowledge-Bases/galerina-hardware-apple.md`
...
`docs/Knowledge-Bases/galerina-hardware-arm.md`
...
`docs/Knowledge-Bases/galerina-hardware-as-capabilities.md`
...
`docs/Knowledge-Bases/galerina-hardware-compute-fabric.md`
...
`docs/Knowledge-Bases/galerina-hardware-google.md`
...
`docs/Knowledge-Bases/galerina-hardware-npu-apu.md`
...
`docs/Knowledge-Bases/galerina-hardware-targets.md`
...
`docs/Knowledge-Bases/galerina-hybrid-wasm-native-architecture-v1.md`
...
`docs/Knowledge-Bases/galerina-i64-lowering-plan-verified-2026-06-25.md`
...
`docs/Knowledge-Bases/galerina-integrity-audit-2026-06-15.md`
...
`docs/Knowledge-Bases/galerina-metadata-erasure.md`
...
`docs/Knowledge-Bases/galerina-microservice-architecture.md`
...
`docs/Knowledge-Bases/galerina-naming-philosophy.md`
...
`docs/Knowledge-Bases/galerina-nvidia-n1x-target.md`
...
`docs/Knowledge-Bases/galerina-paper-worthiness-assessment-2026-06-22.md`
...
`docs/Knowledge-Bases/galerina-paper-worthiness-assessment-2026-06-23.md`
- tasks: #219, #194
...
`docs/Knowledge-Bases/galerina-passive-execution-plans.md`
...
`docs/Knowledge-Bases/galerina-percent-audit-and-benchmarks-2026-06-25.md`
...
`docs/Knowledge-Bases/galerina-performance-plan.md`
...
`docs/Knowledge-Bases/galerina-performance-roadmap.md`
...
`docs/Knowledge-Bases/galerina-phase-26-healthcare.md`
...
`docs/Knowledge-Bases/galerina-phase40-vision.md`
...
`docs/Knowledge-Bases/galerina-provenance-integrity-vs-fidelity.md`
- tasks: #36
...
`docs/Knowledge-Bases/galerina-rd-0110-photonic-matmul-refutation-deepened-2026-06-24.md`
- tasks: #10
...
`docs/Knowledge-Bases/galerina-rd-0128-cicd-native-testgen.md`
- tasks: #57
...
`docs/Knowledge-Bases/galerina-rd-62-maths-expansion-2026-06-25.md`
...
`docs/Knowledge-Bases/galerina-rd-graph-secrets-and-runtime-graph-2026-06-25.md`
- tasks: #102
...
`docs/Knowledge-Bases/galerina-rd-graph-wasm-admission-benchmark-2026-06-25.md`
- tasks: #149
...
`docs/Knowledge-Bases/galerina-rd-graph-wasm-photonic-2026-06-25.md`
...
`docs/Knowledge-Bases/galerina-roadmap-2026-06-21.md`
...
`docs/Knowledge-Bases/galerina-roadmap-and-audit-2026-06-17.md`
...
`docs/Knowledge-Bases/galerina-roadmap-and-percent-audit-2026-06-22.md`
...
`docs/Knowledge-Bases/galerina-roadmap-and-percent-audit-2026-06-23.md`
...
- terms: wasm, post-p9, galerina, real, sequence, dss, status, security, byte-parity, critical, roadmap, view, verified, self-hosting

## Galerina Route Runtime Specification
`docs/Knowledge-Bases/galerina-route-runtime-spec.md`
...
`docs/Knowledge-Bases/galerina-runtime-lifecycle.md`
...
`docs/Knowledge-Bases/galerina-runtime-rationale.md`
...
`docs/Knowledge-Bases/galerina-security-taint-types.md`
...
`docs/Knowledge-Bases/galerina-stage-b-root-capability-provider.md`
...
`docs/Knowledge-Bases/galerina-stdlib-reference.md`
...
`docs/Knowledge-Bases/galerina-syntax-if-match-optional.md`
...
`docs/Knowledge-Bases/galerina-syntax-loops-iteration.md`
...
`docs/Knowledge-Bases/galerina-tensor-numeric-performance.md`
...
`docs/Knowledge-Bases/galerina-tree-walker-speed-and-photonic-governance.md`
...
`docs/Knowledge-Bases/galerina-tritmesh-meshql-shortest-path-parked.md`
...
`docs/Knowledge-Bases/galerina-unified-syntax-governance-and-target-bridge-plan.md`
...
`docs/Knowledge-Bases/galerina-wasm-compilation-granularity.md`
- tasks: #102, #94, #105
...
`docs/Knowledge-Bases/what-galerina-refuses-to-become.md`
