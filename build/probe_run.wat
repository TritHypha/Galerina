(module
  ...
  ;; pure flow: calc
  (func $calc (param $p0 i32) (param $p1 i32) (result i32)
    (call $lln_checked_sub_i32 (call $lln_checked_add_i32 (call $lln_checked_mul_i32 (local.get $p0) (local.get $p1)) (local.get $p0)) (local.get $p1))
  )
