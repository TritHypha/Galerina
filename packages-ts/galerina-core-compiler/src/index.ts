...
// Phase 4 — Lexer
// Detached artifact boundary — references and owner-local repositories only.
export {
  ...
  decodeArtifactReferenceBytes,
  decodeComputeTransfer,
  decodeComputeTransferBytes,
  digestArtifactBytes,
  encodeArtifactReference,
  encodeComputeTransfer,
  verifyArtifactBytes,
  type ArtifactKind,
  type ArtifactOwner,
...
export {
  ...
  CHECKED_MODULE_SNAPSHOT_MAX_ITEMS,
  CHECKED_MODULE_SNAPSHOT_SCHEMA,
  CheckedModuleSnapshotRefusal,
  computeSnapshotRunIdentity,
  decodeCheckedModuleSnapshot,
  digestCheckedModuleSnapshot,
  encodeCheckedModuleSnapshot,
  validateCheckedModuleSnapshot,
  type CheckedModuleSnapshotV1,
  type SnapshotCheckerIdentityV1,
  type SnapshotCompilerIdentityV1,
  type SnapshotConstantV1,
  type SnapshotDeclarationV1,
  type SnapshotDiagnosticV1,
  type SnapshotEffectV1,
  type SnapshotGovernanceFactV1,
  type SnapshotLimitsV1,
  type SnapshotResolvedTypeV1,
  type SnapshotRunIdentityV1,
  type SnapshotSourceIdentityV1,
  type SnapshotSourceSpanV1,
...
export { buildAdmissionStatement, verifyAdmissionBindings, GATE_V3_ADMISSION_CODES } from "./gate-v3-admission.js";
...
export { verifySLIDEV2BHybridLeaseSignature } from "./slide-v2b-crypto-verifier.js";
export type {
  SLIDEV2BCryptoVerdict,
  SLIDEV2BHybridLeaseSignature,
...
export {
  ...
  REQUIREMENT_TAINT_ATOMS,
  MAX_REQUIREMENT_TAINT_ATOMS,
  MAX_REQUIREMENT_VALIDATOR_CHECKED_FLOWS,
  MAX_REQUIREMENT_VALIDATOR_EFFECT_RESULTS,
  MAX_REQUIREMENT_CHECKED_FLOW_DIGEST_NODES,
  MAX_REQUIREMENT_CHECKED_FLOW_DIGEST_DEPTH,
  MAX_REQUIREMENT_CHECKED_FLOW_DIGEST_BYTES,
  MAX_REQUIREMENT_CHECKED_FLOW_DIGEST_PARAMS,
  MAX_REQUIREMENT_CHECKED_FLOW_DIGEST_EFFECTS,
  ...
  type RequirementTaintAtom,
  type RequirementTaintAnalysis,
  type RequirementValidatorCheckedFlowEvidence,
