...
> [`../../../ZTF-Knowledge-Bases/reference/galerina/galerina-framework-layer-design.md`](../../../ZTF-Knowledge-Bases/reference/galerina/galerina-framework-layer-design.md).
...
```text
/packages-ts/galerina-api-adapters
  /express
  /fastify
  /aws-lambda
  /cloudflare-worker
...
```text
[ ] Create /packages-ts/galerina-framework-api-server
[ ] Add README.md
[ ] Add TODO.md
...
[ ] Add placeholder /packages-ts/galerina-api-adapters
```
