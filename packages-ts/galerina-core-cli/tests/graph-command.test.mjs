      ...
      `${JSON.stringify(
        {
          ...
          packages: [
            ...
            "packages-ts/galerina-core-security",
            "packages-ts/galerina-devtools-project-graph",
          ],
          docs: {
            language: "packages-ts/galerina-core",
            security: "packages-ts/galerina-core-security",
            projectGraph: "packages-ts/galerina-devtools-project-graph",
          },
        },
        null,
        2,
