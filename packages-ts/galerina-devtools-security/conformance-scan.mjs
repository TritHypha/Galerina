...
const FL = "packages-ts/galerina-framework-app-kernel/src/fuse-loader.ts";
const HV = "packages-ts/galerina-core-compiler/src/lmanifest-hybrid-verifier.ts";
const CONTAINER = "packages-ts/galerina-ext-spore/src/container.ts";
const BA = "packages-ts/galerina-tower-citizen/src/bridge-attestation.ts";
const HE = "packages-ts/galerina-tower-citizen/src/hybrid-engine.ts";
const KEMDEM = "packages-ts/galerina-ext-spore/src/kemdem.ts";
const ARENA = "packages-ts/galerina-ext-secrets-spore/src/arena.ts";
