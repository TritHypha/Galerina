...
```text
Tri / Galerina / Omni work should update packages-ts/galerina-core-logic first.
Vector work should update packages-ts/galerina-core-vector first.
Compute planning work should update packages-ts/galerina-core-compute first.
AI inference work should update packages-ts/galerina-ai first.
Low-bit AI backend work should update packages-ts/galerina-ai-lowbit first.
Photonic vocabulary should update packages-ts/galerina-core-photonic first.
Target backend work should update packages-ts/galerina-target-native or
packages-ts/galerina-target-cpu, packages-ts/galerina-target-wasm, packages-ts/galerina-target-gpu or
packages-ts/galerina-target-photonic first.
CPU kernel work should update packages-ts/galerina-cpu-kernels first.
Compiler pipeline work should update packages-ts/galerina-core-compiler first.
Runtime execution work should update packages-ts/galerina-core-runtime first.
Security primitive work should update packages-ts/galerina-core-security first.
Config and report shape work should update packages-ts/galerina-core-config or
packages-ts/galerina-core-reports first.
...
```text
Tri, Galerina, Decision and Omni semantics -> packages-ts/galerina-core-logic/TODO.md
Vector values, lanes and operation semantics -> packages-ts/galerina-core-vector/TODO.md
Compute planning and target selection -> packages-ts/galerina-core-compute/TODO.md
AI inference contracts -> packages-ts/galerina-ai/TODO.md
Low-bit AI backend -> packages-ts/galerina-ai-lowbit/TODO.md
Photonic concepts and simulation helpers -> packages-ts/galerina-core-photonic/TODO.md
CPU target planning -> packages-ts/galerina-target-cpu/TODO.md
CPU kernel planning -> packages-ts/galerina-cpu-kernels/TODO.md
Binary/native target output -> packages-ts/galerina-target-native/TODO.md
WASM target output -> packages-ts/galerina-target-wasm/TODO.md
GPU target output -> packages-ts/galerina-target-gpu/TODO.md
Photonic target output -> packages-ts/galerina-target-photonic/TODO.md
Compiler pipeline implementation -> packages-ts/galerina-core-compiler/TODO.md
Runtime execution contracts -> packages-ts/galerina-core-runtime/TODO.md
Security primitives and report contracts -> packages-ts/galerina-core-security/TODO.md
Config loading contracts -> packages-ts/galerina-core-config/TODO.md
Shared report schemas -> packages-ts/galerina-core-reports/TODO.md
CLI command UX and dispatch -> packages-ts/galerina-core-cli/TODO.md
Safe task automation -> packages-ts/galerina-core-tasks/TODO.md
API transport -> packages-ts/galerina-framework-api-server/TODO.md
Application boundary enforcement -> packages-ts/galerina-framework-app-kernel/TODO.md
```
