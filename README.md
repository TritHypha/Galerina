...
| **Tests — full suite** | 100% | **68/68 packages · 6,315 tests · 0 failures** |
...
```bash
# Tests — core suite (4 packages) / full suite (68 packages, 6,315 tests)
