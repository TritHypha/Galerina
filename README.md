...
| **Tests — full suite** | 100% | **81/81 packages · 6,553 tests · 0 failures** |
...
```bash
# Tests — core suite (4 packages) / full suite (81 packages, 6,553 tests)
