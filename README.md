...
| **Tests — full suite** | 100% | **94/94 packages · 7,498 tests · 0 failures** |
...
```bash
# Tests — core suite (4 packages) / full suite (94 packages, 7,498 tests)
