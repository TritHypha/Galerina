...
| **Tests — full suite** | 100% | **95/95 packages · 7,552 tests · 0 failures** |
...
```bash
# Tests — core suite (4 packages) / full suite (95 packages, 7,552 tests)
