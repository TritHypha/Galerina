...
| **Tests — full suite** | 100% | **92/92 packages · 7,104 tests · 0 failures** |
...
| Item | State | Detail |
|---|---|---|
| **Execution-cutover (RD-0361)** | building | execution column shipped · **7 twins differential** (syncgate · passive-replay · inference · pq-admission · registry-index · package-admission · b8-admission — R0→R1 #105→R3 ≡ real `.ts`) · 21 shadow · T2–T5 + fuse-admission pending · R4 authority flip 🔒 owner (#143) |
...
| **Devtools audit suite** | shipped | 75 tools · 41 audits · keep-green + gate-selftests meta-gate; twin-audit execution column shipped (shadow\|differential\|authoritative) |
...
| **Missing R&D (0363/0364/0365)** | building | RD-0363 replay-admission + RD-0364 inference-governance decision surfaces authored + **executing through #105**; RD-0365 design-done; P/I wiring increments (P1/P4, I1–I6) pending |
...
```bash
# Tests — core suite (4 packages) / full suite (92 packages, 7,104 tests)
