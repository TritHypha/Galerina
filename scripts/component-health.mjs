...
const ZERO_TRUST = [
  ...
  { boundary: "TLSTP — zero-middleware", pct: 33, status: "◑ S1 K3 cert/channel gate + deny-by-default CORS admission DECISION surfaces twinned (cert-gate.fungi: pin · chain · expiry · revocation vAnd-fold, unknown→DENY; cors-policy.fungi: null-origin · wildcard+creds · exact-allowlist · preflight method/header — all fail-closed) · in-sandbox decryption = target (DSS.wasm TCB, #143 switch)" },
];
