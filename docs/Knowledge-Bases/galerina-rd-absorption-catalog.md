...
> **⏩ STALENESS (2026-06-22): complete ONLY as of pin `238f07a` (2026-06-17).** R&D has since advanced through **0064**; bridge tasks **0045–0064 are NOT folded in here** — they are tracked in [galerina-rd-corpus-closure-2026-06-18.md](galerina-rd-corpus-closure-2026-06-18.md) (0036–0052), [galerina-build-roadmap.md](galerina-build-roadmap.md) (0053/0054 built as packages), and [galerina-rd-0059-0064-triage-2026-06-22.md](galerina-rd-0059-0064-triage-2026-06-22.md). The "nothing is silently missing" guarantee below holds **up to the pin only** — re-run the `feedback-auto-import-rd-docs` sweep + re-pin to restore it. (The §2 "32 mirrored" count also drifted — the `rd-absorbed/` dir now holds 38 `rd-*.md`.)

**Galerina is the single "main library."** Every durable knowledge doc from the R&D repo
(`C:\wwwprojects\Galerina-R-AND-D`) is accounted for here so nothing is silently missing. Built from a 49-doc
...
- **vendored** → format **specs** copied into the engine package `packages-galerina/galerina-ext-tmf/spec/` (provenance pin in that folder's `PROVENANCE` note). These ARE the implementation contract.
...
- **curated** → high-value strategic content rewritten as a flat first-class KB doc (graph-indexed): `galerina-quantum-resilience-roadmap.md`, and the pre-existing `galerina-*` docs listed under "native view".
...
## 1. Specs — vendored into `galerina-ext-tmf/spec/`
`tmx-256-construction-v0` · `tmf-container-v0` · `tmf-modalities-v0` · `tmf-encryption-v0` · `signature-custody-v0` · `threshold-custody-v0` · `inclusion-proof-v0` · `tmf-history-chain-v0` · `governed-trust-capsule-v0` · `nvfp4-codec-v0`. Curated view: `galerina-tmf-engine.md`. The golden generators `tmf/spec/_vectors/*.py` stay upstream as the authoring oracle (binding conformance = the in-package golden tests).

## 2. Mirrored verbatim into `rd-absorbed/` (32 docs)
| R&D source | `rd-absorbed/` mirror | Curated/native view |
|---|---|---|
| QUANTUM-RESILIENCE-STANDARD-AND-ROADMAP.md | `rd-absorbed/rd-quantum-resilience-standard-and-roadmap.md` | **galerina-quantum-resilience-roadmap.md** |
| NOVELTY-AND-IP-ASSESSMENT.md | `rd-absorbed/rd-novelty-and-ip-assessment.md` | (primary home is the mirror) |
| VERIFICATION-FINDINGS-2026-06-16.md | `rd-absorbed/rd-adversarial-verification-findings-2026-06-16.md` | galerina-security-audit cluster |
| RESEARCH-PHASE-photonic-signing-and-trust-capsule.md | `rd-absorbed/rd-photonic-signing-and-trust-capsule.md` | galerina-quantum-resilience-roadmap.md |
| RESEARCH-PHASE-privacy-governance.md | `rd-absorbed/rd-privacy-governed-compile-time-primitive.md` | galerina-privacy-embedding-egress.md |
| tmf/research/external-repos-analysis.md | `rd-absorbed/rd-external-repos-grounding-ledger.md` | galerina-external-idea-mining-2026-06-15.md |
| tmf/research/photonic-lane-A-accelerated-signing.md | `rd-absorbed/rd-photonic-accelerated-lattice-signing.md` | galerina-quantum-resilience-roadmap.md |
| tmf/research/photonic-lane-B-quantum-digital-signatures.md | `rd-absorbed/rd-quantum-digital-signatures-lane-b.md` | galerina-quantum-resilience-roadmap.md |
| tmf/research/photonic-lane-C-optical-puf.md | `rd-absorbed/rd-photonic-lane-c-optical-puf.md` | galerina-quantum-resilience-roadmap.md |
| tmf/research/photonic-lane-D-qrng.md | `rd-absorbed/rd-qrng-entropy-source-for-hybrid-signing.md` | galerina-quantum-resilience-roadmap.md |
...
| tmf/research/real-vs-aspirational-ledger.md | `rd-absorbed/rd-tmf-real-vs-aspirational-ledger.md` | galerina-tmf-engine.md |
...
| diagnostics-namespace-rnd-response.md | `rd-absorbed/rd-diagnostics-namespace-rnd-response.md` | galerina-diagnostic-namespace-ownership.md |
| FFSM/ffsim-build-readiness.md | `rd-absorbed/rd-ffsim-build-readiness.md` | galerina-ext-bridge-quantum-design.md |
| FFSM/ffsim-op-catalog.md | `rd-absorbed/rd-ffsm-ffsim-op-catalog.md` | galerina-ext-bridge-quantum-design.md |
| privacy/privacy-governance-v0.md | `rd-absorbed/rd-privacy-governance-compile-time-design.md` | galerina-privacy-embedding-egress.md |

## 3. catalog_only (19 docs — not imported; disposition + reason)
| R&D source | Reason | Covered by |
|---|---|---|
| README.md, tmf/README.md | folder index / TOC | galerina-tmf-engine.md |
| RND-STATE.md | R&D master resume-state index | galerina-rd-adoption-2026-06-16.md (facts → App. A) |
...
| photonic-tri-governance/direction-c/{00,01}*.md | plan-and-log (Direction C) | galerina-substrate-failure-model.md |
...
|---|---|---|
| `0023-tower-citizen-runtime-verification-access.done.md` | **curated** (V1–V12 / X1–X6 ledger) | **galerina-prove-own-maths-roadmap.md** §1–§2 |
| `PROVE-OWN-MATHS-AUDIT-2026-06-18.md` | **curated** (PROVEN/EXCLUDED/OWED grading of 0001-0023) | **galerina-prove-own-maths-roadmap.md** §3–§4 |
| `0014-recheck-prove-own-maths.done.md` | **curated** (in-flight-PROVEN self-catch lesson) | **galerina-prove-own-maths-roadmap.md** §1b note |
...
|---|---|---|
| `TREE-WALKER-SPEED-RND.md` + `walker-techniques-bench.mjs` | **curated** (de-coloring = #1 lever; the A–G table) | **galerina-tree-walker-speed-and-photonic-governance.md** §1–§2 |
...
## 4. TritMesh repo (`Galerina-TritMesh/TritMesh` @ `5db2e17`) — separate product, referenced not absorbed
TritMesh is a downstream **product** that *consumes* Galerina; its own design-notes mandate "separate repos, no
merge, no shared crypto substrate." So Galerina **references** the seam + conformance (captured in
`galerina-tritmesh-boundary-and-seam.md`) and does **not** mirror the product. All 16 docs accounted for:
...
**Other:** RFC 9964 (May 2026) specifics — COSE-ML-DSA: ML-DSA-65 = COSE alg `-49`, EMPTY ctx, signs the COSE `Sig_structure`; Trust Capsule moved domain separation into the signed `body_protected` `surface` label + `external_aad`. NIST **SP 800-226** grounds the privacy declassifier's `aggregate` label (DP ≠ anonymization; GDPR Art 5(1)(b)+89). GAP-4: `for…in` runs in the interpreter but the WASM wat-emitter has no `forEachStmt` case (emits a no-op stub) → roadmap **#128** (fail-loud). MeshQL/TUFC/Virtio-Trit/systolic-array transport (notes 1–3) remain **gated R&D-only** (not Galerina governance knowledge).

## See also
`galerina-tmf-engine.md` · `galerina-quantum-resilience-roadmap.md` · `galerina-rd-adoption-2026-06-16.md` · `feedback-auto-import-rd-docs` (the standing rule) · `packages-galerina/galerina-ext-tmf/spec/PROVENANCE.md`.
