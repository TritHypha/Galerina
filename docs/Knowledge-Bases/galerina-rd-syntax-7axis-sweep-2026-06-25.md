...
rate-limited out** — RESUME to finish. Findings below were reproduced by compiling + running `.spore` (with an
...
- **The emitter now lowers Int64 faithfully** → the Int64 half of SPORE-NUMERIC-001 is stale; lifting Int64 is a one-set-edit win (owner-gated; leaves UInt64 gated). *Confirms this session's Int64 work.*
