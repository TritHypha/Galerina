...
| `logicn-paper-worthiness-assessment-2026-06-23.md` | **Full-corpus paper-worthiness refresh** (wf `w4zqo3nu8`) — **0 flagship / 0 workshop / 9 defensive-pub**; all ~22 candidates re-derive cited prior art (Kleene/Belnap/Bruns-Huth, Zdancewic-Myers robust-declassification, von-Neumann NMR, simdjson, Zhang-Sanchez memoization-net-negative, Marr "Are We Fast Yet?"). Strongest = benchmark unit-truth (still defensive-pub). PENDING: extend to 0091 + TritMesh/coverage R&D. |
