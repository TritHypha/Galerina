...
`packages-galerina/galerina-framework-app-kernel/src/fuse-loader.ts` — and found:
...
3. Bench code (verbatim port of the real `scanner`/`graph`/`reporter` functions + the harness) is preserved in
   R-AND-D `graph-wasm-admission-bench/`; port into `galerina-devtools-benchmarks` only if #149 proceeds.

*Source: isolated worktree benchmark, 2026-06-25 (agent run, hub-verified numbers). Companion:
[`galerina-rd-photonic-quantum-paging-graph-grounding-2026-06-25.md`](galerina-rd-photonic-quantum-paging-graph-grounding-2026-06-25.md)
