...
**Date:** 2026-06-15.
**Parent agenda:** `galerina-photonic-tri-substrate-rd-agenda.md` §3 (Direction A).
...
distinction `galerina-core` already documents (`tri-logic.md` §4: *"`unknown` is not the same as
