...
**Disclosure ID:** DP-RD-0269 · **Date:** 2026-07-08 · **Type:** Prior-art disclosure (defensive) — NOT a patent claim · **Provenance:** the fail-open retrospective + canonical taxonomy (`ZTF-Knowledge-Bases/galerina-fail-open-taxonomy.md`; in-repo registration `docs/Knowledge-Bases/galerina-fail-open-taxonomy.md`), the syntax security review (`ZTF-Knowledge-Bases/galerina-rd-0266-syntax-security-review-2026-07-08.md`), and the live findings register (RD-0240, BK-1..5, C1/H1–H5/M4). Detector evidence in-repo (§8).
