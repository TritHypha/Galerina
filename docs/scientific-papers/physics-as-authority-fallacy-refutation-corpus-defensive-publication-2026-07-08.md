...
**Disclosure ID:** DP-RD-0270 · **Date:** 2026-07-08 · **Type:** Prior-art disclosure (defensive) — NOT a patent claim · **Provenance:** RD-0111 (`ZTF-Knowledge-Bases/galerina-rd-0111-photonic-3d-brief-rigorous-2026-06-24.md`), RD-0266/0266b/0266c (`ZTF-Knowledge-Bases/galerina-rd-0266*.md`), machine-checked proof `ZTF-Knowledge-Bases/proofs/rd-0266-photonic-syntax-claims-proof.mjs` (15/15, exit 0), rebuttal protocol `ZTF-Knowledge-Bases/PROMPT-gemini-rebuttal-photonic-overclaims-2026-07-08.md` with the source model's concession recorded in RD-0266c §1. Companion to the in-folder notes `latency-is-not-work` (DP, 2026-06-25) and DP-RD-0257 (span-not-work).
