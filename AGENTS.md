...
> is shipped and green (`galerina-core-compiler` at 4,728; whole suite 93/93 · 7,389 tests · 0 fail on a clean checkout). The remaining
...
for the LIVE generated catalog — <!-- registry:counts.live -->133 live codes of <!-- registry:counts.total -->684 total
