...
> is shipped and green (`galerina-core-compiler` at 4,730; whole suite 93/93 · 7,391 tests · 0 fail on a clean checkout). The remaining
...
for the LIVE generated catalog — <!-- registry:counts.live -->128 live codes of <!-- registry:counts.total -->683 total
