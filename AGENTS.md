...
> **Stage-A status (2026-07-12):** the full pipeline lexer→parser→type/effect/value-state→governance-verifier→GIR→WAT
> is shipped and green (`galerina-core-compiler` at 4,504; whole suite 92/92 · 7,103 tests · 0 fail on a clean checkout). The remaining
