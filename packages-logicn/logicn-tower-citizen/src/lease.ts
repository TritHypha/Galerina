 ...
 *    INDETERMINATE → denied (audited LLN-GOV-3VL-001). There is no path by which a
 ...
 *  - **Never silent.** An INDETERMINATE collapse carries LLN-GOV-3VL-001 in the
 ...
 * LLN-GOV-3VL-001 (also forwarded to `onDiagnostic` if provided). Pure: it reads no
