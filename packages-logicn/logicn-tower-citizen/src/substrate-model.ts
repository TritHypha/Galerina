 ...
 *
 * The central result (§4 of logicn-substrate-failure-model.md):
 ...
 *
 * Spec: docs/Knowledge-Bases/logicn-substrate-failure-model.md.
 */
...
// @logicn/substrate-math (the shared single source of truth). This module wraps that
 ...
 * @logicn/substrate-math so the simulator and the compiler verifier share ONE implementation.
 */
 ...
 * @logicn/substrate-math (shared with the compiler — single source of truth).
 */
...
// ── Diagnostics — LLN-SUBSTRATE-* (fail-closed) ───────────────────────────────

export const SUBSTRATE_DIAGNOSTICS = {
  CRYPTO_ON_NOISY_LANE: "LLN-SUBSTRATE-001",
  TOLERANCE_UNACHIEVABLE_UNDER_NOISE: "LLN-SUBSTRATE-002",
  REDUNDANCY_INSUFFICIENT: "LLN-SUBSTRATE-003",
  UNVOTED_ANALOG_INTO_DETERMINISTIC: "LLN-SUBSTRATE-004",
} as const;
 ...
 * un-voted-analog-into-deterministic yields DENY + an LLN-SUBSTRATE-* diagnostic.
