 ...
 * (executeFlow + the raw emit path skip checkValueStates) — LLN-NUMERIC-001 stays CLOSED for real run/build.
 */
...
// [flowName, paramNames, walkerArgs(LogicNValues), wasmArgs(JS), expect: bigint | "trap"]
const CORPUS = [
