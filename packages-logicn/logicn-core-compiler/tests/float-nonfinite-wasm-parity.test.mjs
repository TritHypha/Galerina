...
// float (mkFloat / floatCmp, LLN-FLOAT-NAN-001); the WASM tier must trap IDENTICALLY or the fail-open simply
// moves to the opt-in WASM path. The wat-emitter now wraps every f64 arithmetic RESULT and ordering-compare
// OPERAND in $lln_assert_finite_f64 (traps `unreachable` on NaN/±Inf) and rejects a non-finite f64.const.
