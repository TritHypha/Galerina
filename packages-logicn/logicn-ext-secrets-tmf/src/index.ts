// @logicn/ext-secrets-tmf — sealed secrets on the .tmf container (OPTIONAL, ext tier).
//
// A THIN orchestration layer over @logicn/ext-tmf (format/crypto) + the
// @logicn/ext-secrets-vault store DISCIPLINE. NO new crypto, NO new container bytes.
