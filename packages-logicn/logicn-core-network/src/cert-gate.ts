 ...
 *
 * Build guide: docs/Knowledge-Bases/logicn-tlstp-s1-cert-gate.md
 */
...
// a verdict / decision without reaching across into @logicn/tower-citizen.
export { Verdict };
 ...
 *
 * `onDiagnostic` receives LLN-GOV-3VL-001 whenever an INDETERMINATE (`0`) verdict
