...
const ENTRIES = [
  { name: "Auth.Standard", version: "1.2.0", sourceHash: "sha256:aaa", publisher: "logicn-certified",
  ...
  { name: "Auth.Standard", version: "1.1.0", sourceHash: "sha256:old", publisher: "logicn-certified",
