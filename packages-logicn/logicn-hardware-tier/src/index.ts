// @logicn/hardware-tier — the Tri-Pipe hardware() directive + per-tier package loader.
//
...
//
// Neutral: depends only on @logicn/inference-bridge-contract (types). The attestation result is
// injected (verifyAttestation lives in the Tower, on the BRIDGE surface). Composes the photonic
// substrate from @logicn/ext-photonic-emulator.
