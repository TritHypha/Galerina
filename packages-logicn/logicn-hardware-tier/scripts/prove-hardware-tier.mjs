...
// Composes the 0053 route() (@logicn/ext-photonic-emulator) for the AXIS-2 cost model.
//
...
// H5 — K3 dead-zone.
{
  ...
  ok("H5 unknown target ⇒ K3 INDETERMINATE ⇒ DENY ⇒ binary (LLN-HW-004)", undef && deny, "get(unknown)=undefined → binary");
}
...
// summary
let fails = 0;
console.log("\n-- @logicn/hardware-tier — prove-own-maths (0054 D1 directive H1–H5 + D3 orthogonality O1–O4) --");
