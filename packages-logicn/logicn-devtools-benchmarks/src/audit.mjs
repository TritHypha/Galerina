 ...
 *   4. Anti-inflation regression — on numeric-loop benchmarks the LogicN tree-walker
...
// benchmark → the field holding its deterministic, FIXED-WORK checksum. LogicN rows
...
console.log("\n4. Anti-inflation regression (LogicN governed must not beat Node.js)");
