...
function main() {
  ...
  if (options.help) {
    console.log("Usage: node node.mjs [--target 042069] [--max 2000000] [--mode sequential|random]");
    return;
  }
  validate(options);
...
try { main(); } catch (e) { console.error(`six-digit benchmark failed: ${e.message}`); process.exitCode = 1; }
