...
import { writeTmf } from "../../../logicn-ext-tmf/dist/index.js";

// tmf-container — ".tmf trust-container CREATION" throughput.
//
// THE NODE.JS COLUMN IS LITERALLY LOGICN'S SHIPPED ENGINE. `@logicn/ext-tmf` is
// pure TypeScript-on-Node (no `.lln` execution path exists), so its creation
...
function runBench(iterations) {
  ...
  return {
    ...
    note: "Node.js column = @logicn/ext-tmf engine (the shipped LogicN artifact)",
