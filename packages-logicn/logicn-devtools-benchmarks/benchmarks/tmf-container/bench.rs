...
// builds with the suite's plain `rustc -O` harness. Byte-identical to the LogicN
// @logicn/ext-tmf engine: it asserts the SAME published golden root before timing,
