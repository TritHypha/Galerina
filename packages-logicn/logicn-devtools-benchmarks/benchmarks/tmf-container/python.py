...
# Byte-identical to @logicn/ext-tmf (Python stdlib `hashlib.shake_256` IS the spec's
...
def main():
    ...
    print(json.dumps({
        ...
        "notes": ["Python reference impl (hashlib.shake_256) — byte-identical to the LogicN engine"],
    }, indent=2))
