...
- **This is not a "LogicN wins on speed" benchmark.** The App Kernel is plain JS, so it
...
- **The real "remove middleware" win is structural, not throughput** — a scorecard the
  ...
  | Property | LogicN App Kernel | Express/Flask + middleware |
  |---|---|---|
