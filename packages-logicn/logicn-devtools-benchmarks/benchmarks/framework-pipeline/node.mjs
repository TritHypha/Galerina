...
import { createAppKernel } from "../../../logicn-framework-app-kernel/dist/kernel.js";

// framework-pipeline — "native framework (no middleware)" vs "middleware chain".
//
// The Node.js column is LogicN's SHIPPED App Kernel: a FIXED, non-bypassable
...
// ── The LogicN App Kernel (the framework) ────────────────────────────────────
let auditCount = 0;
...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    note: "Node.js column = LogicN App Kernel (fixed 12-gate pipeline, no middleware)",
