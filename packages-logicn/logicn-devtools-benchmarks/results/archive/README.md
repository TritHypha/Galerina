...
- `../full-suite-2026-06-16.json` — full run **BEFORE the unit-normalization fix**. Its LogicN throughput numbers are **inflated** (the "LogicN wins" bug); do not trust/compare its LogicN rows. Kept only for historical reference.
