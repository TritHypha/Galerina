 ...
 * cert-gate (@logicn/core-network, docs/Knowledge-Bases/logicn-tlstp-s1-cert-gate.md)
 ...
 * performs no ASN.1 parsing, path-building, or signature math itself. logicn-auth
...
} from "../../logicn-core-network/dist/index.js";
import type {
  Verdict,
 ...
 * pin mismatch) refuse.
 *
 * `onDiagnostic` (optional) receives LLN-GOV-3VL-001 if an INDETERMINATE verdict is
