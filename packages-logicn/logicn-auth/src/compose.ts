 ...
 * whole contract of this package: logicn-auth supplies the authentication FACTORS;
 ...
 * at its own gate. `onDiagnostic` receives LLN-GOV-3VL-001 when an INDETERMINATE
