 ...
 *
 * Run (after `node ../logicn-tower-citizen/node_modules/typescript/lib/tsc.js -p tsconfig.json`):
...
const doc = generateOpenApi({
  info: { title: "Orders API", version: "1.0.0", description: "A governed LogicN order service." },
