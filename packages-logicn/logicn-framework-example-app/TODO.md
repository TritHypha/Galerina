# LogicN Example App — status

Promoted from a doc-only scaffold to the **runnable golden template** (`logicn new app`).

```text
[x] App entry            src/App.lln (composition-root flow main())
[x] App flow             src/flows/greeting.lln (governed, contract{intent})
