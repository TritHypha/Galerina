...
// NOTE: a near-identical reachability module lives in `@logicn/devtools-project-graph`,
...
// decision). This package (`@logicn/devtools-graph-algorithms`) is the canonical copy for
